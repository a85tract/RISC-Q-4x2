...
_SIM2Q = Path(__file__).resolve().parents[3] / "gateware" / "configs" / "sim-2q.json"
_SIM2Q1C = Path(__file__).resolve().parents[3] / "gateware" / "configs" / "sim-2q1c.json"
_X6Y3 = Path(__file__).resolve().parents[2] / "examples" / "zcu216" / "cal-config-x6y3.yaml"
