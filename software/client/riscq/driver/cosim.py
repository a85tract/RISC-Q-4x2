"""CosimDriver: Pyro5 proxy to the cocotb co-sim bench (riscq_sim.bench). Implements the
...
class CosimDriver:
    ...
    def __init__(self, uri: str):
        ...
        self._proc = None  # set by riscq_sim.cosim.start()
